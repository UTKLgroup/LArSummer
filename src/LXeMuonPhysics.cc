...
void LXeMuonPhysics::ConstructProcess()
{
  ...
  G4MuBremsstrahlung* fMuPlusBremsstrahlung=		// Radiative Proc.
    new G4MuBremsstrahlung();				// Radiative Proc.
  G4MuPairProduction* fMuPlusPairProduction=		// Radiative Proc.
    new G4MuPairProduction();				// Radiative Proc.

  G4MuIonisation* fMuMinusIonisation =
    new G4MuIonisation();
  G4MuMultipleScattering* fMuMinusMultipleScattering =
    new G4MuMultipleScattering();
  G4MuBremsstrahlung* fMuMinusBremsstrahlung =		// Radiative Proc.
    new G4MuBremsstrahlung();				// Radiative Proc.
  G4MuPairProduction* fMuMinusPairProduction =		// Radiative Proc.
    new G4MuPairProduction();				// Radiative Proc.
  ...
  pManager->AddProcess(fMuPlusBremsstrahlung,    -1,  3, 3);	// Radiative Proc.
  pManager->AddProcess(fMuPlusPairProduction,    -1,  4, 4);	// Radiative Proc.
